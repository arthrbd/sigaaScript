...
#Preenche e entra
driver.find_element(By.NAME, "username").send_keys("252014789")
driver.find_element(By.ID, "password").send_keys("Sjp34831827@")
...
driver.find_element(By.XPATH, '//*[@id="form:txtCodigo"]').send_keys("FGA0158")
